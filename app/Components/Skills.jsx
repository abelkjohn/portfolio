...
export default function Skills(){
    return (
        <div className="flex w-11/12 justify-center mx-auto gap-6 flex-wrap lg:flex-nowrap">
            <div className="pt-4 md:w-1/3 lg:w-1/3 flex flex-col">
                ...
                <a className="p-2 bg-cyan-200 w-fit rounded-lg mt-4 mx-auto md:ml-0 lg:ml-0" href="/abelsResume.pdf" download="abelsResume.pdf">My Résumé</a>
            </div>
            </div>
