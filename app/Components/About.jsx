...
export default function About(){
    return (
        <div id="about" className="border-2 border-white">
            <div  className="flex flex-col lg:flex-row mx-3 gap-4 mt-20 lg:m-28 lg:mb-6 lg:mt-32 border-2 border-white text-center lg:text-left">
                <img className="rounded-full h-min w-80 mx-auto" src={Me.src} />
                <div className="flex flex-col justify-center">
                    <h1 className="text-lg">About Abel K John</h1>
                    <p className="mx-3 mb-5">I&apos;m Abel K John, a budding React.js front-end developer. Proficient in HTML, CSS, JavaScript and Next.js, I specialize in crafting user-friendly web experiences. My projects are born from a desire to meet unique needs, showcasing a blend of creativity and technical skill.</p>
